...
meta = {
    'bill_length_mm': (float(X_train.bill_length_mm.min()),
                       float(X_train.bill_length_mm.max())),
    'flipper_length_mm':(float(X_train.flipper_length_mm.min()),
                       float(X_train.flipper_length_mm.max())),
